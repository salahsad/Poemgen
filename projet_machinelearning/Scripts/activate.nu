...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\SALAH_SAD\PycharmProjects\serviceMongoDB'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\SALAH_SAD\PycharmProjects\serviceMongoDB\Scripts\deactivate.nu'
