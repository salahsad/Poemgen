...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\SALAH_SAD\PycharmProjects\pyinserAmongo'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\SALAH_SAD\PycharmProjects\pyinserAmongo\Scripts\deactivate.nu'
